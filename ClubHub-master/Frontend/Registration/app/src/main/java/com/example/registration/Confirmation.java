...
import com.example.registration.app.AppController;
import com.example.registration.net_utils.Const;
...
class Confirmation extends Activity implements OnClickListener {

    private String TAG = Confirmation.class.getSimpleName();
