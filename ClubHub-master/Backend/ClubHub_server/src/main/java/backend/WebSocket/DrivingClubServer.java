...
@ServerEndpoint("/websocket/driving/{username}")
@Component

/**
 * 
 * @author Danny Yip, Cobi Mom
 * class of a driving club
 */
public class DrivingClubServer {
    	      ...
    	      @PathParam("username") String username) throws IOException 
    {
        ...
        String message = username + " has Joined The Driving Club's Chat";
        	broadcast(message);
